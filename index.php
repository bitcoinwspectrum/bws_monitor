...
<!DOCTYPE html>
<html>
<title>BITCOIN W SPECTRUM (BWS) NODE MONITOR</title>
<meta charset="UTF-8">
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right"><b>BWSv1.0.1.9 monitor</b> | <?php print $version;?></span>
</div>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  ...
  <?php
    ...
    if(!empty($getnetworkinfo)){
      if(!empty($mnaddress)){
        ...
        echo 'Masternode Address : <tr><a href=http://' . $bws_explorer . '/address/' . $mnaddress . '>' . $mnaddress . '</a></tr>';
        echo "<td><a href=http://" . $bws_explorer . "/address/" . $mnlist[$i]->{'addr'} .">" . $mnlist[$i]->{'addr'} . "</a></td>";
      }
      elseif(empty($mnaddress)){
        echo '<li class="w3-padding-16 w3-orange">';
        echo '<span class="w3-xlarge">';
        echo 'BWS Daemon is running but is not a Masternode';
      }
    }
    else{
      echo '<li class="w3-padding-16 w3-orange">';
      echo '<span class="w3-xlarge">';
      echo 'Cannot connect to BWS node [url=' . $rpc_url . '] [port=' . $rpc_port . ']';
      echo '</br>';
      echo '- Edit <b>rpc_user</b> and <b>rpc_password</b> in <b>config.php</b> (use the same credentials as bws.conf)';
      echo '</br>';
      echo '- Maybe your bws daemon is not running';
    }
    echo '</li>';
    echo '</ul>';
    echo '</div>';
  ...
  if(!empty($mnstatus)){
        ...
        echo '<br>';
        echo '<h3>BWS Masternode Status</h3>';
  ...
  <footer class="w3-container w3-padding-16 w3-dark-grey">
    <h3 class="w3-bottombar w3-border-blue">Support Bitcoin W Spectrum (BWS)</h3>
    <p>Source code on <a href="https://github.com/mining4altcoins/bws_monitor" target="_blank">GitHub</a></p>
    <p>Bitcoin W Spectrum Links :
      <a href="http://217.163.23.222:3000">Explorer</a> |
      <a href="https://discord.gg/Vng6uyK">Discord</a> |
      <a href="https://t.me/bitcoinwspectrum">Telegram</a> |
      <a href="https://bitcoinwspectrum.com/">Website</a> |
      <script src="https://widgets.coingecko.com/coingecko-coin-price-chart-widget.js"></script>
<coingecko-coin-price-chart-widget currency="btc" coin-id="bitcoin-w-spectrum" locale="en" height="100" width="0"></coingecko-coin-price-chart-widget>
    </p>
  </footer>
